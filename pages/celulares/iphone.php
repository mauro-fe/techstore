...
<main class="py-5">
    <div class="container">
        <div class="row g-5 cards-container mt-1">
            <h2 class="text-center fw-bold section-title">iPhone</h2>
                        ...
                        <div class="card-front card border-0 shadow-sm">
                            ...
                            <div class="card-body d-flex align-items-center justify-content-around">
                                ...
                                <button class="btn btn-enhanced btn-comprar" data-nome="<?= $iphone->nome ?>"
                                    data-id="<?= $iphone->id ?>" data-cor="<?= $iphone->especificacoes['cor'] ?? '' ?>"
                                    data-armazenamento="<?= $iphone->especificacoes['armazenamento'] ?? '' ?>">
                                ...
                                <div class="w-100 spec-scroll">
                                    <div class="spec-item">
                                        ...
                                        <div class="text-start">
                                            ...
                                            <small><?= $iphone->especificacoes['tela'] ?? 'N/A' ?></small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="spec-item">
                                        ...
                                        <div class="text-start">
                                            ...
                                            <small><?= $iphone->especificacoes['armazenamento'] ?? 'N/A' ?></small>
                                        </div>
                                    </div>
                                    <div class="spec-item">
                                        <div class="spec-icon">
                                        ...
                                        <div class="text-start">
                                            ...
                                            <small><?= $iphone->especificacoes['cor'] ?? 'N/A' ?></small>
                                        </div>
                                    </div>
                                    <div class="spec-item">
                                        <div class="spec-icon">
                                        ...
                                        <div class="text-start">
                                            ...
                                            <small><?= $iphone->especificacoes['sistema-operacional'] ?? 'N/A' ?></small>
                                        </div>
                                    </div>
                                </div>
