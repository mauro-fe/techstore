                        ...
                        <div class="card-front card border-0 shadow-sm">
                            ...
                            <div class="card-body d-flex align-items-center justify-content-around">
                                ...
                                <button class="btn btn-enhanced btn-comprar" data-nome="<?= $realme->nome ?>"
                                    data-id="<?= $realme->id ?>" data-cor="<?= $realme->especificacoes['cor'] ?? '' ?>"
                                    data-armazenamento="<?= $realme->especificacoes['armazenamento'] ?? '' ?>">
                        ...
                        <div class="card-back card border-0 shadow-sm">
                                ...
                                <div class="w-100 spec-scroll">
                                    <div class="spec-item">
                                        ...
                                        <div class="text-start">
                                            ...
                                            <small><?= $realme->especificacoes['tela'] ?? 'N/A' ?></small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="spec-item">
                                        ...
                                        <div class="text-start">
                                            ...
                                            <small><?= $realme->especificacoes['armazenamento'] ?? 'N/A' ?></small>
                                        </div>
                                    </div>
                                    <div class="spec-item">
                                        <div class="spec-icon">
                                        ...
                                        <div class="text-start">
                                            ...
                                            <small><?= $realme->especificacoes['cor'] ?? 'N/A' ?></small>
                                        </div>
                                    </div>
                                    <div class="spec-item">
                                        <div class="spec-icon">
                                        ...
                                        <div class="text-start">
                                            ...
                                            <small><?= $realme->especificacoes['sistema-operacional'] ?? 'N/A' ?></small>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body d-flex align-items-center">
                                <button class="btn btn-enhanced btn-ver-detalhes" data-bs-toggle="modal"
                                    data-bs-target="#modalDetalhes" data-nome="<?= $realme->nome ?>"
                                    data-id="<?= $realme->id ?>" data-pasta="<?= $realme->pastaImagens ?>"
                                    data-processador="<?= $realme->especificacoes['Processador'] ?? '' ?>"
                                    data-camera="<?= $realme->especificacoes['camera'] ?? '' ?>"
                                    data-bateria="<?= $realme->especificacoes['Bateria'] ?? '' ?>">
