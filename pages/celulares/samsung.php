...
<main class="py-5">
    <div class="container">
        <div class="row g-5 cards-container mt-1">
            <h2 class="text-center fw-bold section-title">Samsung</h2>
                ...
                <div class="card-flip">
                    <div class="card-inner">
                        ...
                        <div class="card-front card border-0 shadow-sm">
                            <h5 class="card-title fw-semibold text-center"><?= $samsung->nome ?></h5>
                            <?php
                                $imagens = getImagesForModel($samsung->pastaImagens);
                                $imagemPrincipal = $imagens[0] ?? $samsung->imagem;
                                ?>

                            <img src="<?= $imagemPrincipal ?>" class="card-img-top" alt="<?= $samsung->nome ?>">
                            <div class="card-body d-flex align-items-center justify-content-around">
                                <button class="btn btn-enhanced btn-ver-detalhes">
                                    <i class="fas fa-info-circle "></i> Ver Detalhes
                                </button>
                                <button class="btn btn-enhanced btn-comprar" data-nome="<?= $samsung->nome ?>"
                                    data-id="<?= $samsung->id ?>"
                                    data-cor="<?= $samsung->especificacoes['cor'] ?? '' ?>"
                                    data-armazenamento="<?= $samsung->especificacoes['armazenamento'] ?? '' ?>">
                        ...
                        <div class="card-back card border-0 shadow-sm">
                            <div
                                ...
                                <h5 class="fw-semibold mb-4"><?= $samsung->nome ?></h5>
                                ...
                                <div class="w-100 spec-scroll">
                                    <div class="spec-item">
                                        ...
                                        <div class="text-start">
                                            ...
                                            <small><?= $samsung->especificacoes['tela'] ?? 'N/A' ?></small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="spec-item">
                                        ...
                                        <div class="text-start">
                                            ...
                                            <small><?= $samsung->especificacoes['camera'] ?? 'N/A' ?></small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="spec-item">
                                        ...
                                        <div class="text-start">
                                            ...
                                            <small><?= $samsung->especificacoes['Bateria'] ?? 'N/A' ?></small>
                                        </div>
                                    </div>
                                    <div class="spec-item">
                                        <div class="spec-icon">
                                        ...
                                        <div class="text-start">
                                            ...
                                            <small><?= $samsung->especificacoes['armazenamento'] ?? 'N/A' ?></small>
                                        </div>
                                    </div>
                                    <div class="spec-item">
                                        <div class="spec-icon">
                                        ...
                                        <div class="text-start">
                                            ...
                                            <small><?= $samsung->especificacoes['cor'] ?? 'N/A' ?></small>
                                        </div>
                                    </div>
                                    <div class="spec-item">
                                        <div class="spec-icon">
                                        ...
                                        <div class="text-start">
                                            ...
                                            <small><?= $samsung->especificacoes['sistema-operacional'] ?? 'N/A' ?></small>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body d-flex align-items-center">
                                <button class="btn btn-enhanced btn-ver-detalhes" data-bs-toggle="modal"
                                    data-bs-target="#modalDetalhes" data-nome="<?= $samsung->nome ?>"
                                    data-id="<?= $samsung->id ?>" data-pasta="<?= $samsung->pastaImagens ?>"
                                    data-processador="<?= $samsung->especificacoes['Processador'] ?? '' ?>"
                                    data-camera="<?= $samsung->especificacoes['camera'] ?? '' ?>"
                                    data-bateria="<?= $samsung->especificacoes['Bateria'] ?? '' ?>">
